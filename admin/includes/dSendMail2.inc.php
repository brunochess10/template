...
class dSendMail2 extends htmlMimeMail2{
...
class htmlMimeMail2  {
    ...
    */
    function &_addTextPart(&$obj, $text)
    {
        ...
        if (is_object($obj)) {
            ...
            $return = new Mail_mimePart2($text, $params);
        }
    ...
    */
    function &_addHtmlPart(&$obj)
    {
        ...
        if (is_object($obj)) {
            ...
            $return = new Mail_mimePart2($this->html, $params);
        }
    ...
    */
    function &_addMixedPart()
    {
        ...
        $return = new Mail_mimePart2('', $params);
...
class Mail_mimePart2 {
     ...
     * @access public
     */
    function Mail_mimePart2($body = '', $params = array()){
        if (!defined('MAIL_MIMEPART_CRLF')) {
