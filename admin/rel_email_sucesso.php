...
?>
	...
	<thead>
		<tr>
			...
			<th class="centro">Relatório de e-mails enviados com sucesso</th>
...
<tr>
	...
	<legend>Relatório de e-mails enviados com sucesso</legend>	
	<div id="texto">
	<p>
	
	</p>
	<h1>Relatório de e-mails enviados com sucesso</h1>
	<?php
		$mail_id = request("mail_id");
		$sql = "SELECT L.*, M.usr_email FROM log_mail L inner JOIN mailing M on (L.mailing_id=M.usr_id) WHERE L.status='1' and L.mail_id='$mail_id'";
	...
	?>
		<tr>
			...
			<td><img src="images/certo.png" width="10px" height="10px" ></td>
		</tr>
	<?php
		}
	?>	
