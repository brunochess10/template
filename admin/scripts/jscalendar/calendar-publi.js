...
// $Id: calendar-publi.js,v 1.7 2004/09/21 22:23:15 theo Exp $
 ...
 */
Calendar.prototype.create = function (loc, _par) {
	var parent = null;
	if (! _par) {
...
if(this.loc == "geral") {
	...
	this._nav_now = hh(Calendar._TT["TODAY"], this.weekNumbers ? 8 : 7, 0);
	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
