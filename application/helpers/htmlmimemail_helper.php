...
* Last Modified..: $Date: 2003/12/19 11:35:33 $
* CVS Revision...: $Revision: 1.1 $
* Copyright......: 2001, 2002 Richard Heyes
*/

require_once(dirname(__FILE__) . '/mimepart_helper.php');
...
*/
/* Troquei essa função por uma do mesmo nome do arquivo: dSendMail2.inc.php
   Pois no From sempre que havia acento ele grudava as palavras
...
*/
	function send($recipients, $type = 'mail')
	{
		...
		switch ($type) {
			...
			case 'smtp':
				require_once(dirname(__FILE__) . '/smtp_helper.php');
				require_once(dirname(__FILE__) . '/rfc822_helper.php');
...
//Include nas classes dSendMail2, onde foi implementada uma classe extendida
//da htmlMimeMail para enviar email por Gmail / Yahoo / hotmail e também onde
//Coloquei uma classe intermediaria criada pela Neo Solutions para envio de emails
//Assim essa classe intermediaria poderá escolher o script para envio de emails sem precisar
//alterar o código fonte.

require_once(dirname(__FILE__) . '/dsendmail2.inc_helper.php');
require_once(dirname(__FILE__) . '/standardmail_helper.php');
